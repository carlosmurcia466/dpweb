...
<center><br><br><br><br>
    <table width="80%" border="0" height="70" align="center" >
                ...
                <table class="pro">
                   ...
                   /* mysql_query('SELECT cl.nombre, cl.apellido, cd.nombre, dp.nombre FROM clientes cl '
                            . 'INNER JOIN ciudades cd ON cd.idciudad= cl.idciudad INNER JOIN departamento dp '
                            . 'ON cd.iddepto=dp.iddepto');  */



                     $resultado = mysqli_query($conexion, '
                        SELECT usuarios.idUsuario, usuarios.user, usuarios.nombres, usuarios.apellidos, usuarios.correo,'
                             . 'usuarios.telefono, productos.nombre, productos.foto, cotizaciones.idCotizacion, cotizaciones.mensaje FROM ((cotizaciones INNER JOIN usuarios '
                             . 'ON usuarios.idUsuario= cotizaciones.idUsuario) INNER JOIN productos ON productos.idProducto= cotizaciones.idProducto)');
                    ...
                    while ($registro = mysqli_fetch_array($resultado)) {
                        ...
                        <tr>
                            ...
                            <td><a href="mmttoCompras.php?id=<?php echo $registro['idCotizacion'] ?>&a=m">Modificar</a></td>
                            <td><a onclick="return confirmSubmit()" href="mmttoCompras.php?id=<?php echo $registro['idCotizacion'] ?>&a=e">Eliminar</a></td>
                        </tr>
