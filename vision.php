    ...
    <table id="informacion" width="80%" border="0" height="70" align="center" >
        <tr>
            <td colspan="4" whdth="65">
                ...
                <br><br><br><br><br><br>
                <p>Ser reconocidos como la venta en línea mas complaciente para el
                    hogar y  electrodomésticos con un acceso confiable y de reputación indudable para cada uno de nuestros clientes, 
                    gestionando el mantenimiento de dicha línea y su sistema de proteccion.</p>

                <br><br><br><br><br><br>
                <div align="center">
                    <img src="fotos/vissiooon.jpg">
                </div>
