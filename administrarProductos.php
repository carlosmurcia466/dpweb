...
<center><br><br><br><br>
    <table width="80%" id="pro" height="70" align="center" >
                    ...
                    <td></td>
                      ...
                      while ($registro = mysqli_fetch_array($resultado)) {
                          ...
                          <tr>
                              ...
                              <td><a href="modificarProducto.php?id=<?php echo $registro['idProducto'];?>">Modificar</a></td>
                              <td><a href="eliminarProducto.php?id=<?php echo $registro['idProducto'];?>">Eliminar</a></td>
                          </tr>
